...
/* to upper layer. In case of this exposure time and ISO */
			...
			/* read exposure time */
			sr030pc50_sensor_read(0xa0, &data);
			msb = (unsigned short)data;
			sr030pc50_sensor_read(0xa1, &data);
			msb = (msb << 8) | (unsigned short)data;
			sr030pc50_sensor_read(0xa2, &data);
			lsb = (unsigned short)data;
			sr030pc50_sensor_read(0xa3, &data);
			lsb = (lsb << 8) | (unsigned short)data;

			/* read ISO gain */
			sr030pc50_sensor_read(0x50, &data);
